...
readFiles(recipeDir, function (name, html) {
    ...
    if (recipe.time.totalMins){
        recipeData.total = recipe.time.totalMins;
    }
    ...
    titleDB["Title"] = recipe.title;
    titleDB["data"] = recipeData;
    fs.appendFileSync('titlesedited3.txt', JSON.stringify(titleDB));
    fs.appendFileSync('titlesedited3.txt', ",");
...
/*
    ...
    */
    ...
    //fs.writeFile('titlesedited2.json', JSON.stringify(titleDB));
